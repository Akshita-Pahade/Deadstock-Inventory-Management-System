...
DB_CONFIG = dict(host='127.0.0.1', user='root', password='YOUR_DB_PASSWORD', database='deadstock_db')

# ── Email config ────────────────────────────────────────────────────
MAIL_SENDER   = 'YOUR_EMAIL@gmail.com'      # ← change to your Gmail
MAIL_PASSWORD = 'YOUR_GMAIL_APP_PASSWORD'         # ← change to your App Password
...
def alert_warehouse_head_items_sent(branch_id):
    ...
    try:
        ...
        if wh_row:
            ...
            print("Warehouse Head ID:", wh_head_id)
            print("Phone:", phone)
            if phone:
                msg = (
